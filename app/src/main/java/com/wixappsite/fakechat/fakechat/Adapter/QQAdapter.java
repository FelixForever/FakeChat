...
import com.wixappsite.fakechat.fakechat.Activity.QQActivity;
...
public class QQAdapter extends BaseAdapter {
    ...
    private QQActivity qqActivity;
    private List<Message> myList;


    public QQAdapter(Context context, List<Message> myList,QQActivity qqActivity) {
        this.myList = myList;
        ...
        if (convertView == null ||convertView.getTag()==null) {
            ...
            switch (type) {
                ...
                case RECV_TEXT:
                    ...
                    convertView=mInflater.inflate(R.layout.qq_row_recv_msg,
                            null);
                ...
                case RECV_IMAGE:
                    ...
                    convertView = mInflater.inflate(R.layout.qq_row_recv_img,
                            null);
             ...
             //       convertView.setTag(holderRecvImg);
                ...
                case RECV_AUDIO:
                    ...
                    convertView = mInflater.inflate(R.layout.qq_row_recv_voice,
                            null);
                    ...
                    holderRecvAudio.btnRecvAudio.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            qqActivity.ShowDialog(position);
                        }
                    });
                ...
                case SEND_TEXT:
                    ...
                    convertView = mInflater.inflate(R.layout.qq_row_sent_message,
                            null);
                ...
                case SEND_IMAGE:
                    ...
                    convertView = mInflater.inflate(R.layout.qq_row_send_img,
                            null);
                ...
                case SEND_AUDIO:
                    ...
                    convertView = mInflater.inflate(R.layout.qq_row_send_voice,
                            null);
                    ...
                    if(msg.getLength()>=1) {
                        ...
                        holderSendAudio.btnSendAudio.setPadding(77 + msg.getVoice_length() * 3, 0, 0, 0);
                    }
